    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
                ...
                <p class="text-gray-400 mb-4">Your one-stop shop for all your electronic needs. We offer high-quality
                ...
                <div class="flex space-x-4">
                    ...
                    <a href="#" class="text-gray-400 hover:text-white">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
                                d="M12.073 0C18.646 0 24 5.354 24 11.927c0 6.573-5.354 11.927-11.927 11.927S.146 18.5.146 11.927C.146 5.354 5.5.146 12.073.146zm0 2.195c-5.373 0-9.732 4.359-9.732 9.732 0 5.373 4.359 9.732 9.732 9.732 5.373 0 9.732-4.359 9.732-9.732 0-5.373-4.359-9.732-9.732-9.732z" />
                        </svg>
                    </a>
                </div>
            </div>
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="/sale" class="text-gray-400 hover:text-white">Sale Items</a></li>
                    <li><a href="/new-arrivals" class="text-gray-400 hover:text-white">New Arrivals</a></li>
                    <li><a href="/bestsellers" class="text-gray-400 hover:text-white">Bestsellers</a></li>
                </ul>
            </div>
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="/shipping" class="text-gray-400 hover:text-white">Shipping Policy</a></li>
                    <li><a href="/returns" class="text-gray-400 hover:text-white">Returns & Exchanges</a></li>
        ...
        <div class="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            {{-- <div class="flex space-x-4 mt-4 md:mt-0">
                ...
                <img src="https://via.placeholder.com/40x25/6B7280/ffffff?text=AMEX" alt="American Express"
                    class="h-6">
                <img src="https://via.placeholder.com/40x25/6B7280/ffffff?text=PP" alt="PayPal" class="h-6">
            </div> --}}
        </div>
    </div>
</footer>
