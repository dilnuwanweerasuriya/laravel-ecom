            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/categories*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
                        ...
                        <i class="material-symbols-rounded opacity-5">style</i>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/brands*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
                        href="/admin/brands">
                        <i class="material-symbols-rounded opacity-5">computer</i>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/orders*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
                        href="/admin/orders">
                        <i class="material-symbols-rounded opacity-5">package</i>
                        <span class="nav-link-text ms-1">Orders</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/reviews*') ? 'active bg-gradient-dark text-white' : 'text-dark' }}"
                        href="/admin/reviews">
